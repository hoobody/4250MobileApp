...
namespace UnitTests.Engine.EngineGame
{
    ...
    public class TurnEngineGameTests
    {
        ...
        [Test]
        public void TurnEngine_UseAbility_Valid_Ability_Assassin_Should_Pass()
        {
            // Arrange

            var characterPlayer = new PlayerInfoModel(new CharacterModel { Job = CharacterJobEnum.Assassin });
        ...
        [Test]
        public void TurnEngine_UseAbility_Valid_Ability_Detective_Should_Pass()
        {
            // Arrange

            var characterPlayer = new PlayerInfoModel(new CharacterModel { Job = CharacterJobEnum.Detective });
        ...
        [Test]
        public void TurnEngine_UseAbility_Valid_Ability_Hacker_Should_Pass()
        {
            // Arrange

            var characterPlayer = new PlayerInfoModel(new CharacterModel { Job = CharacterJobEnum.Hacker });
        ...
        [Test]
        public void TurnEngine_UseAbility_Valid_Ability_SpecialAgent_Should_Pass()
        {
            // Arrange

            var characterPlayer = new PlayerInfoModel(new CharacterModel { Job = CharacterJobEnum.SpecialAgent });
        ...
        [Test]
        public void TurnEngine_UseAbility_Valid_Ability_SpecialAgent_Actually_Heal_Should_Pass()
        {
            // Arrange
            var characterPlayer = new PlayerInfoModel(new CharacterModel { Job = CharacterJobEnum.SpecialAgent });
        ...
        [Test]
        public void TurnEngine_UseAbility_Valid_Ability_Spy_Should_Pass()
        {
            // Arrange

            var characterPlayer = new PlayerInfoModel(new CharacterModel { Job = CharacterJobEnum.Spy });
