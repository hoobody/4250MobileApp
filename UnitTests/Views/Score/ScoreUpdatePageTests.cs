...
namespace UnitTests.Views
{
    ...
    public class ScoreUpdatePageTests : ScoreUpdatePage
    {
        ...
        [Test]
        public void ScoreUpdatePage_CheckifReadyToSubmit_Valid_All_But_Name_With_Whitespace_Should_Pass()
        {
            // Arrange
        ...
        [Test]
        public void ScoreUpdatePage_CheckifReadyToSubmit_Valid_All_But_Name_Should_Pass()
        {
            // Arrange
            var NameEntry = page.FindByName("NameEntry");
            ((Entry)NameEntry).Text = "";
