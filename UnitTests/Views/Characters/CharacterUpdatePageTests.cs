...
namespace UnitTests.Views
{
    ...
    public class CharacterUpdatePageTests : CharacterUpdatePage
    {
        ...
        [Test]
        public void CharacterUpdatePage_CheckifReadyToSubmit_Valid_All_But_Name_Should_Pass()
        {
            // Arrange
        ...
        [Test]
        public void CharacterUpdatePage_CheckifReadyToSubmit_Valid_All_But_Description_Should_Pass()
        {
            // Arrange
        ...
        [Test]
        public void CharacterUpdatePage_CheckifReadyToSubmit_Valid_All_But_CodeName_With_Whitespace_Should_Pass()
        {
            // Arrange
            var CodenameEntry = page.FindByName("CodenameEntry");
            ((Entry)CodenameEntry).Text = " ";
        ...
        [Test]
        public void CharacterUpdatePage_CheckifReadyToSubmit_Valid_All_But_Name_With_Whitespace_Should_Pass()
        {
            // Arrange
            var NameEntry = page.FindByName("NameEntry");
            ((Entry)NameEntry).Text = " ";
        ...
        [Test]
        public void CharacterUpdatePage_CheckifReadyToSubmit_Valid_All_But_Description_With_Whitespace_Should_Pass()
        {
            // Arrange
            var DescriptionEntry = page.FindByName("DescriptionEntry");
            ((Entry)DescriptionEntry).Text = " ";
